        ...
        if (cellHash < uDensity) {
            ...
            if (toIntersection > 0.0) {
                ...
                if (dist < flakeSize) {
                    ...
                    gl_FragColor = vec4(uColor * pow(vec3(intensity), vec3(uGamma)), 1.0 * intensity);
                    return;
                }
            }
        }
...
export default function PixelSnow({
    ...
    }, [handleResize, flakeSize, minFlakeSize, pixelResolution, speed, depthFade, farPlane, brightness, gamma, density, variantValue, direction, colorVector]);
